...
export default function KnowYourRightsClinic() {
  // Get the specific event data
  const event = eventsData.find(e => e.id === 'evt-2');
        ...
        <div className="col-md-8">
          ...
          <div className="card mb-4">
            ...
            <div className="card-body">
              ...
              <p className="card-text">
                Attend our Know Your Rights clinic to learn about your legal rights and protections 
                in Texas. This essential workshop covers immigration rights, interactions with law 
                enforcement, workplace protections, and available legal resources. Our legal experts 
                will provide practical guidance and answer your questions in a safe, supportive environment.
              </p>
