...
export default function AustinAlliesImmigrantCare() {
  const org = orgsData.find(o => o.id === 'org-2');
        ...
        <div className="col-md-8">
          ...
          <div className="card mb-4">
            ...
            <div className="card-body">
              ...
              <p>
                Austin Allies for Immigrant Care provides comprehensive legal support 
                and advocacy for Austin's immigrant community. We specialize in immigration 
