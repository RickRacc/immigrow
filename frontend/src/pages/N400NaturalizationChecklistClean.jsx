...
export default function N400NaturalizationChecklistClean() {
  const resource = resourcesData.find(r => r.id === 'res-1');
        ...
        <div className="col-md-8">
          ...
          <div className="card mb-4">
            ...
            <div className="card-body">
              ...
              <p>The N-400 Naturalization Checklist is an essential federal resource designed to guide immigrants through the U.S. citizenship application process.</p>
