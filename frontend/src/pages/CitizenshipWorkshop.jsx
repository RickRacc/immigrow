...
export default function CitizenshipWorkshop() {
  // Get the specific event data
  const event = eventsData.find(e => e.id === 'evt-1');
        ...
        <div className="col-md-8">
          ...
          <div className="card mb-4">
            ...
            <div className="card-body">
              ...
              <p className="card-text">
                Join us for a comprehensive citizenship workshop designed to help immigrants 
                navigate the naturalization process. This workshop will cover the N-400 application, 
                test preparation, and interview tips. Our experienced staff will guide you through 
                each step of becoming a U.S. citizen.
              </p>
